...
import com.oriadesoftdev.retrofitrxjava3.databinding.ActivityMainBinding
import com.oriadesoftdev.retrofitrxjava3.ui.TaskViewModel
import com.oriadesoftdev.retrofitrxjava3.ui.adapter.TaskPagingAdapter
import com.oriadesoftdev.retrofitrxjava3.ui.adapter.TaskRecyclerViewAdapter
import com.oriadesoftdev.retrofitrxjava3.ui.paging.TaskPagingViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var taskPagingViewModel: TaskPagingViewModel
    private lateinit var mSearchView: SearchView
    private lateinit var mRecyclerView: RecyclerView
    private lateinit var mProgressBar: ProgressBar
    private lateinit var mListAdapter: TaskRecyclerViewAdapter
    private lateinit var mTaskPagingAdapter: TaskPagingAdapter
...
//            ).get()
        ...
        taskPagingViewModel = ViewModelProvider(
            this,
            TaskPagingViewModelFactory(
                TaskRepositoryPagingImpl(
                    TaskPagingSource((application as MyApplication).networkService)
                )
            )
        )[TaskPagingViewModel::class.java]

        mTaskPagingAdapter = TaskPagingAdapter()
        observers()
...
//            deleteTask(it)
        ...
        mRecyclerView.apply {
            ...
            adapter = mTaskPagingAdapter
        }

        mTaskPagingAdapter.addLoadStateListener {
            binding.progressBar.isVisible = it.source.refresh is LoadState.Loading
            binding.taskListRecyclerView.isVisible = it.source.refresh is LoadState.NotLoading
    ...
    private fun observers() {
        taskPagingViewModel.getAllTaskPaging().observeOn(AndroidSchedulers.mainThread()).subscribe({
            mTaskPagingAdapter.submitData(lifecycle, it)
        }) {
...
//    }
    ...
    class TaskPagingViewModelFactory(private val repository: TaskRepositoryPagingImpl) :
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return modelClass.getConstructor(TaskRepositoryPagingImpl::class.java)
